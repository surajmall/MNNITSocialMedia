	    ...
	    <div id="head_wrap">
		 ...
		 <div class="content">
			...
			<div id="content_timeline">
				...
				<center style="padding:10px;"><h2><strong>Ask your query and start discussion !</strong></h2></center>
				<input type="text" class="form-control" name="title" placeholder="Write a title" style="width:350px; padding:10px; margin-left:15px; font-weight:bolder;"/></br>
				<textarea class="form-control" cols="70" rows="4" name="content" style="width:550px; padding:10px; margin-left:15px; font-weight:bolder;" placeholder="Ask your query here in detail ..."></textarea></br>
				<strong style="float:right;"><input type="file" style="width:400px;" name="p_image"/></strong>
				...
				<button type="submit" class="btn btn-primary" name="sub" style="float:right; margin-right:25px; margin-bottom:15px;">Ask Now</button>
				</form>
				<?php InsertPost(); ?>
			    <div id="posts">
				    <h3>Recent posts</h3>
