     ...
     <div class="contain">
	    ...
	    <div id="head_wrap">
			...
			<form method="post" action="result.php" id="form1">
				<div class="row">
				    <input type="text" name="email" placeholder="Search" style="width:200px;"/>
		 ...
		 <div class="content">
			    ...
			    <div id="user_detail">
				    <?php
						...
						echo "
							...
							<center><p><a href='my_posts.php'>My Posts</a></p></center>
			...
			<div id="content_timeline" style="background:rgb(233, 235, 238);">
			<br><center><h3><strong width="600px;" style="color:brown;">Registered Members on this forum</strong><h3></center><br>
			    <?php
						...
						<a href='user_profile.php?user_id=$user_id'>
						    <div style='padding:10px; width:260px; float:left; border:1px solid black; margin-left:20px; margin-bottom:20px;'>
						    <img src='user/user_images/$user_image' width='50px' height='50px' title='$user_name'/>
							<h4 style='float:right; padding:10px; margin-right:10px; color:brown;'><strong>$user_name</strong></h4>
							</div>
							</a>
						";  }
?>						
