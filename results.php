	    ...
	    <div id="head_wrap">
			...
			<img src="images/logo.png" style="float:left; height:88px;" />
			    <ul id="menu">
					...
					<li><a href=".php">Complains</a></li>
					<li><a href=".php">Confessions</a></li
					<li><a href=".php">Other</a></li>
				</ul>
			</div>
			<!--header ends-->
		 ...
		 <div class="content">
			...
			<div id="content_timeline">
				<center style="padding:10px;"><h2><strong>Your search Result -</strong></h2></center>
				<?php get_results(); ?>
			</div>
